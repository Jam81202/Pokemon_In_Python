...
def route_three(w, h):
    ...
    # Overworld Map
    route_three_sketch = Background(0 - w, 0 - h)
    ...
    trainer1 = Player(route_three_sketch.x + BG_W / 2 - 300, route_three_sketch.y + BG_H / 2)
    trainer2 = Player(route_three_sketch.x + BG_W / 2 - 425, route_three_sketch.y + 125)
    trainer3 = Player(route_three_sketch.x + 225, route_three_sketch.y + BG_H - 125)
    ...
    while run:
        ...
        if player.y + 65 >= route_three_sketch.y + BG_H:
            WIN.fill(BLACK)
        ...
        if player.y <= route_three_sketch.y and route_three_sketch.x <= -600:
            WIN.fill(BLACK)
            LOADING_SCREEN = Button("LOADING. . . ", (WIDTH / 2 - 200, HEIGHT / 2), font=50, bg="navy", feedback="loading")
            LOADING_SCREEN.show(LOADING_SCREEN)
            pygame.display.update()
        ...
        if player.y <= route_three_sketch.y:
            WIN.fill(BLACK)
            LOADING_SCREEN = Button("LOADING. . . ", (WIDTH / 2 - 200, HEIGHT / 2), font=50, bg="navy", feedback="loading")
            LOADING_SCREEN.show(LOADING_SCREEN)
            pygame.display.update()
